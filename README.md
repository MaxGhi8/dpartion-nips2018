...
* [C++ source code](https://github.com/stegua/dpartion-nips2018/tree/master/network_simplex_lemon) of our solver for the *(d+1)*-partite formulation. Our implementation relies on the 
